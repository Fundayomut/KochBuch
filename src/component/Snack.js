...
export default function Breakfast() {
  ...
  useEffect(() => {
    fetch(
      `https://api.edamam.com/api/recipes/v2?type=public&mealType=Snack&app_id=8b8e8a1e&app_key=5fc119115d877bf753b2f99f094b7eb1`
    )
      .then((res) => res.json())
      .then((json) => {
        setSnack(json.hits);
  ...
  return (
    <div className="typeheaderdiv">
      <h1 className="typeheader">Snack</h1>
